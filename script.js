...
menu.addEventListener('click', function (a) {
    function clear() {
        ...
        for (let i = 0; i < btn.length; i++) {
            btn[i].getElementsByTagName('img')[0].style.backgroundColor = 'black';
            btn[i].style.height = '12vw';
            btn[i].style.marginTop = '4vw';
            btn[i].getElementsByTagName('h2')[0].style.opacity = '0';
        }
    }
    if (a.target.classList[0] === 'nav') {
        clear();
        a.target.parentElement.getElementsByTagName('img')[0].style.backgroundColor = 'white';
        a.target.parentElement.style.height = '16vw';
        a.target.parentElement.style.marginTop = '0vw';
        a.target.parentElement.getElementsByTagName('h2')[0].style.opacity = '1';
...
btnLeft.addEventListener('click', function (a) {
    ...
    if (a.target.classList[0] === 'nav') {
        ...
        a.target.parentElement.getElementsByTagName('img')[0].style.backgroundColor = 'white';
        a.target.parentElement.getElementsByTagName('h2')[0].style.opacity = '1';
        a.target.parentElement.style.marginLeft = '0vw';
        left.getElementsByTagName('nav')[0].style.display = 'block';
        left.querySelector('.equipment').style.display = 'none';
    }
...
btnRight.addEventListener('click', function (a) {
    ...
    if (a.target.classList[0] === 'shop') {
        ...
        a.target.parentElement.getElementsByTagName('img')[0].style.backgroundColor = 'white';
        a.target.parentElement.getElementsByTagName('h2')[0].style.opacity = '1';
        a.target.parentElement.style.marginLeft = '1vw';
        right.querySelector('.shop').style.display = 'flex';
        right.querySelector('.inventory').style.display = 'none';
        right.querySelector('.shop').getElementsByTagName('span')[0].innerHTML = '<img src="images/icon/shop.png" alt=""/>' + player.gold.toString() + 'G';
    }
    ...
    elm.getElementsByTagName('img')[0].addEventListener('click', function () {
        ...
        if (elm.getElementsByTagName('img')[0].getAttribute('src') != 'images/icon/none.png') {
            if (confirm('Unequip this item?')) {
                ...
                unequip(elm.getElementsByTagName('img')[0]);
            }
        }
    });
});
...
toDungeonbtn.addEventListener('click', function () {
    ...
    const btnL = document.querySelector('.btnWraperL').querySelectorAll('.btn');
    for (let i = 0; i < btnL.length; i++) {
        btnL[i].getElementsByTagName('h2')[0].style.color = 'white';
    }
    const btnR = document.querySelector('.btnWraperR').querySelectorAll('.btn');
    for (let i = 0; i < btnR.length; i++) {
        btnR[i].getElementsByTagName('h2')[0].style.color = 'white';
    }
    document
        .querySelector('.game')
        ...
        .forEach(function (shp) {
            ...
            shp.parentElement.getElementsByTagName('img')[0].style.backgroundColor = 'black';
            right.querySelector('.shop').style.display = 'none';
        });
...
function escape() {
    ...
    const btnL = document.querySelector('.btnWraperL').querySelectorAll('.btn');
    for (let i = 0; i < btnL.length; i++) {
        btnL[i].getElementsByTagName('h2')[0].style.color = 'black';
    }
    const btnR = document.querySelector('.btnWraperR').querySelectorAll('.btn');
    for (let i = 0; i < btnR.length; i++) {
        btnR[i].getElementsByTagName('h2')[0].style.color = 'black';
    }
    if (pHp <= 0) {
...
exploreBtn.addEventListener('click', function () {
    ...
    if (0 <= enemyCode && enemyCode < 4) {
        ...
        game.querySelector('.enemy')
            .querySelector('.monster')
            .setAttribute('src', 'images/monster/' + enemy[enemyCode].image);
...
cnsl.querySelector('.dungeon')
    .querySelector('.RPS')
    .querySelector('.defending')
    .addEventListener('click', function () {
        judging(enemyMoveMechanics(), 'defending');
    });
cnsl.querySelector('.dungeon')
    .querySelector('.RPS')
    .querySelector('.spelling')
    .addEventListener('click', function () {
